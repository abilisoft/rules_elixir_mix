...
def _prebuilt_build(repository_ctx, name, installation):
    repository_ctx.template(
        ...
        substitutions = {
            ...
            "%{LIBC}": repository_ctx.attr.libcs.get(name, ""),
...
{target_constraints}    ],
        ...
        libc = _quote(repository_ctx.attr.libcs[name]),
...
{constraints}    ],
        ...
        libc = _quote(repository_ctx.attr.bootstrap_libcs[name]),
...
elixir_config = repository_rule(
    ...
    attrs = {
        ...
        "bootstrap_libcs": attr.string_dict(),

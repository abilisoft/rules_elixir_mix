...
OtpInfo = provider(
    ...
    fields = {
        ...
        "target_abi": "Rust target ABI spelling for the selected runtime: gnu or musl.",
        "target_arch": "Rust target architecture spelling for the selected runtime.",
        "target_os": "Rust target operating-system spelling for the selected runtime.",
    },
)

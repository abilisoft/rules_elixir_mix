...
The signed [`v0.2.0` GitHub release](https://github.com/abilisoft/rules_elixir_mix/releases/tag/v0.2.0)
...
```console
git fetch https://github.com/abilisoft/rules_elixir_mix.git tag v0.2.0
